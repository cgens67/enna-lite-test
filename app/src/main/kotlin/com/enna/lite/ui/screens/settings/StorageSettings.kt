...
import com.enna.lite.constants.MaxImageCacheSizeKey
...
import com.enna.lite.extensions.tryOrNull
...
import com.enna.lite.ui.player.CanvasArtworkPlaybackCache
import com.enna.lite.ui.utils.backToMain
import com.enna.lite.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                com.enna.lite.utils.ArtworkStorage.clear(context)
            }
        }
    }
